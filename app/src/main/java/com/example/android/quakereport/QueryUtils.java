...
public final class QueryUtils {
     ...
     */
    public static ArrayList<earth> extractEarthquakes() {
        ...
        try {
            ...
            for (int i=0; i<jsonArray.length();i++){
                ...
                String tMag = propertyObject.getString("mag");
                String tPlace = propertyObject.getString("place");
                String tTime = propertyObject.getString("time");

                earthquakes.add(new earth(tMag,tPlace,tTime));
